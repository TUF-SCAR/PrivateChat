...
from src.private_routes.chat import router as chat_post_router
from src.public_routes.register import router as register_router
from src.private_routes.user_chats import router as chat_get_router

app = FastAPI()
app.include_router(register_router)
app.include_router(login_router)
app.include_router(chat_post_router)
